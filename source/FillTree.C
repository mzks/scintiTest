...
void FillTree()
{
  ...
  TFile *f=new TFile("PP1Tree.root","recreate");
  ...
  TTree* pPP1Tree= new TTree("PP1Tree","An example of a tree");
  pPP1Tree->Branch("n",&n,"n/I");
  pPP1Tree->Branch("code",&code,"code[n]/I");
  pPP1Tree->Branch("charge",&charge,"charge[n]/F");
  pPP1Tree->Branch("E",&E,"E[n]/D");
  pPP1Tree->Branch("Px",&Px,"Px[n]/F");
  pPP1Tree->Branch("Py",&Py,"Py[n]/F");
  pPP1Tree->Branch("Pz",&Pz,"Pz[n]/F");
